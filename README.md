...
1. Explain the difference between `RDBMS` and `SQL`. : Relational Database Management System is a database software which manages storing, updating, etc. SQL is what can manipulate the database and create tables, keys, etc.  
1. Why do tables need a `primary key`?: Primary keys are special to the database column which helps identify a table.
1. What is the name given to a table column that references the primary key on another table. :

1. What do we need in order to have a _many to many_ relationship between two tables. :  A foreign key  
